...
class phonesInf(models.Model):
    ...
    admin_id = models.ForeignKey(userInf,related_name='phones_admin',on_delete=models.CASCADE) 
...
class workOrders(models.Model):
    ...
    user_id = models.ForeignKey(userInf,related_name='work_user', on_delete=models.CASCADE)
    server_id = models.ForeignKey(userInf,related_name='work_server', on_delete=models.CASCADE)
    phone_id = models.ForeignKey(phonesInf,related_name='work_phone', on_delete=models.CASCADE)
...
class commitDetails(models.Model):
    commit_id = models.ForeignKey(workOrders,related_name='commit_order', on_delete=models.CASCADE)
    commit_from = models.ForeignKey(userInf, related_name='commit_from_user', on_delete=models.CASCADE)
    commit_to = models.ForeignKey(userInf,related_name='commit_to_user', on_delete=models.CASCADE)
...
class gradesInf(models.Model):
    grade_id = models.ForeignKey(workOrders,related_name='grade_order', on_delete=models.CASCADE)
    user_id = models.ForeignKey(userInf,related_name='grade_user', on_delete=models.CASCADE)
    server_id = models.ForeignKey(userInf, on_delete=models.CASCADE)
...
class aboutInf(models.Model):
    admin_id = models.ForeignKey(userInf,related_name='about_admin',  on_delete=models.CASCADE)
...
class carParts(models.Model):
    ...
    personId = models.ForeignKey(userInf,related_name='admin_user',  on_delete=models.CASCADE)
...
class repairInfo(models.Model):
    ...
    personId = models.ForeignKey(userInf,related_name='repair_user',  on_delete=models.CASCADE)
    def __str__(self):
        return self.repairName
'''
class repairDetails(models.Model):
    detailsId = models.ForeignKey(repairInfo,related_name='repair_id',  on_delete=models.CASCADE)
    detailPartId = models.ForeignKey(carParts,related_name='part_id',  on_delete=models.CASCADE)
    partName = models.CharField(max_length = 40)
